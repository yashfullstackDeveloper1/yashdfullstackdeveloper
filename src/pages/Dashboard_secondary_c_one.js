...
function Role_a_dashboard({ setPage }) {
  ...
  const stats = [
    ...
    },
    {
      count: "50+",
      label: "Total Users",
      description: "All registered users across institutes using the platform services",
    ...
    <div className="dashboard-container">
      ...
      <header className="dashboard-header">
        ...
        <div className="user-controls">
          <span className="location-text">{selectedInstitute.institute_name || 'GNIET Nagpur'}</span>
      ...
      <main className="dashboard-content">
        <section className="welcome-section">
          <h1>Hey Yash 👋</h1>
          <h2>Welcome to MentrixOS Teacher Panel!</h2>
        </section>
